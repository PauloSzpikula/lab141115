	...
	public void onMessage(Message mensagem) {
		...
		try {
			if (mensagem instanceof ObjectMessage) {
				...
				System.out.println("MdbVenda: iniciando a venda...");

				Venda venda;
				venda = (Venda) obj_msg.getObject();

				System.out.println("MdbVenda: nova venda realizada: Id: " + String.valueOf(venda.getId()));
				String inf = "MdbVenda: nova venda realizada: Id: " + String.valueOf(venda.getId());

				System.out.println("MdbVenda: Montando Log...");
				Log log = new Log();
				...
				System.out.println("MdbVenda: Salvando Log...");
				...
				System.out.println("MdbVenda: Processo finalizado!");
			}
